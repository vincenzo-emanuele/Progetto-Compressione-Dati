...
if __name__ == "__main__":   
    ...
    for val in listInput:
        stringInput += val
    #stringInput = "aaabcccccd"
    alphabeth = sorted(set(stringInput))
    print("ALFABETO:", alphabeth, type(alphabeth))
    frequency = {}
    ...
    probability_list = []
    for key in alphabeth:
        probability = frequency[key] / len(stringInput)
        probability_list.append(probability)
    print("PROBS:", probability_list)
    master = tag_encode(alphabeth, probability_list, len(probability_list), stringInput)
    tag_decode(master)
